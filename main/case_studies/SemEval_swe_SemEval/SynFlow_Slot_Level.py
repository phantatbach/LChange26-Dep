...
for selected_lemma in selected_lemmas:
    ...
    slot_json_path = f'../case_studies/SemEval_swe_SemEval/output/{target_lemma}-{target_pos}-1-2/Explorer/{target_lemma}_{target_pos}_spaths.json'
    ...
    all_sfillers_csv_path = f'../case_studies/SemEval_swe_SemEval/output/{target_lemma}-{target_pos}-1-2/Explorer/{target_lemma}_samples_sfillerdf_all.csv'
